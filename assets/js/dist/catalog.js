document.addEventListener("DOMContentLoaded", function () {
     ...
     */
    function generateCatalogList(listElementsName, innerHTML, index) {
        // 创建一个指定类型的列表元素
    ...
    var _loop_1 = function (i, l) {
        var list = generateCatalogList("li", titles[i].$1th.el.innerText, i);
        ...
        for (var j = 0, k = titles[i].$2th.length; j < k; j++) {
            _loop_2(j, k);
        }
